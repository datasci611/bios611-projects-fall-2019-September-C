...
The data consists of 79838 observations and 13 variables (5 categorical variables and 8 numerical variables) from 1931 to 2019. However, since UMD was not established till 1983, I removed the observations with date prior to 1983. For this project, I used the variables 'Date' and 'Food Pounds'.  

## Research Question  

My focus of this project is to look at the amount of food provided by UMD along with its trend in three seperate time periods: before 2000, between 2000 and 2010, and on and after 2010.  
